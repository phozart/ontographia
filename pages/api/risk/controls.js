 ...
 * Risk Controls API
 *
 * GET - Get control effectiveness summary
 */
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const effectiveness = await riskRepository.getControlEffectiveness(domainId);
    return res.json(effectiveness);
  } catch (error) {
    console.error('[Risk Controls API] Error:', error);
