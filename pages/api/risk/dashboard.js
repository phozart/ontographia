 ...
 * Risk Dashboard API
 *
 * GET - Get comprehensive dashboard data for risk module
 */
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const dashboard = await riskRepository.getDashboard(domainId);
    return res.json(dashboard);
  } catch (error) {
    console.error('[Risk Dashboard API] Error:', error);
