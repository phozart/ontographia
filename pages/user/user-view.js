...
export default function UserViewPage() {
  ...
  async function loadData() {
    ...
    try {
      ...
      console.log('[ModelBrowser] Loaded nodes:', { count: scopedNodes.length, sample: scopedNodes[0] });
  ...
  // Server already filters by domain, no need to filter again
  const domainNodes = useMemo(() => enrichedNodes, [enrichedNodes]);
