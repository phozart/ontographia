/**
 * Risk & Resilience Studio Page
 *
 * Main entry point for risk management capabilities.
 */
...
export default function RiskStudioPage() {
    ...
    return (
      <div className="no-project">
        <div className="no-project-card">
          <ShieldIcon style={{ fontSize: 48, color: 'var(--accent, #ef4444)', marginBottom: 16 }} />
          <h2>Risk & Resilience Studio</h2>
          <p>Please select a project to access the Risk & Resilience Studio.</p>
        ...
        <style jsx>{`
          ...
          .no-project-card button:hover {
            background: var(--accent-dark, #dc2626);
          }
        `}</style>
      </div>
    );
  ...
  return (
    <>
      <Head>
        <title>Risk & Resilience Studio | Ontographia</title>
      </Head>
      <RiskProvider>
        <RiskWorkspace />
      </RiskProvider>
