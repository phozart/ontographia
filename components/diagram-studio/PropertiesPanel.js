  ...
  return (
    <div className={`ds-properties ${className}`}>
      ...
      <div className="ds-properties-accordion">
        ...
        {/* Text Styling (elements only) */}
        {isElement && (
          <AccordionSection title="Text Style" defaultOpen={false}>
            <TextStyleSection
              item={item}
              onChange={handleChange}
              readOnly={readOnly || !canEditProperties}
    ...
    <>
      ...
      <div className="ds-property-row">
        <label style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          <input
            type="checkbox"
            checked={item.dashed || false}
            onChange={(e) => onChange('dashed', e.target.checked)}
            disabled={readOnly}
          />
          <span className="ds-property-label" style={{ marginBottom: 0 }}>Dashed Line</span>
        </label>
      </div>
      ...
      <div className="ds-property-row">
        <label style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          <input
            ...
            disabled={readOnly}
          />
          <span className="ds-property-label" style={{ marginBottom: 0 }}>Show Arrow</span>
        </label>
      </div>
    </>
  );
