...
// ============ REQUIREMENT MANAGER (Main Component) ============
export default function RequirementManager({
  ...
  const handleSaveRequirement = (req) => {
    if (editingRequirement) {
      onUpdateArtefact?.(editingRequirement.id, req);
    } else {
      onCreateArtefact?.(req);
    }
    setShowModal(false);
    setEditingRequirement(null);
  };
  ...
  return (
    <div className="ba-requirement-manager">
      ...
      <div className="req-manager-content">
        <div className={`req-manager-list ${selectedRequirement ? 'with-detail' : ''}`}>
          <RequirementList
        ...
        {selectedRequirement && (
          <div className="req-manager-detail">
