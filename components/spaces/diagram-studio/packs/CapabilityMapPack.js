...
// (Inline definitions - previously from lib/cap-types.js)

const CAP_MATURITY_LEVELS = [
  { id: 'initial', label: 'Initial', color: '#dc2626', description: 'Ad hoc, reactive, undocumented' },
  { id: 'developing', label: 'Developing', color: '#f59e0b', description: 'Basic processes defined' },
  { id: 'defined', label: 'Defined', color: '#eab308', description: 'Standardized and documented' },
  { id: 'managed', label: 'Managed', color: '#22c55e', description: 'Measured and controlled' },
  { id: 'optimizing', label: 'Optimizing', color: '#10b981', description: 'Continuous improvement' },
];

const CAP_STRATEGIC_IMPORTANCE = [
  { id: 'commodity', label: 'Commodity', color: '#6b7280', description: 'Basic, undifferentiated' },
  { id: 'enabling', label: 'Enabling', color: '#3b82f6', description: 'Required but not differentiating' },
  { id: 'core', label: 'Core', color: '#8b5cf6', description: 'Key differentiator' },
  { id: 'strategic', label: 'Strategic', color: '#6366f1', description: 'Critical competitive advantage' },
];

const CAP_INVESTMENT_LEVEL = [
  { id: 'divest', label: 'Divest', color: '#dc2626', description: 'Reduce or eliminate' },
  { id: 'maintain', label: 'Maintain', color: '#f59e0b', description: 'Keep at current level' },
  { id: 'grow', label: 'Grow', color: '#22c55e', description: 'Increase investment' },
  { id: 'transform', label: 'Transform', color: '#6366f1', description: 'Major transformation' },
];

const CAP_TYPE_DEFS = {
  capability: { name: 'Capability', color: '#6366f1', icon: '🎯' },
  capability_group: { name: 'Capability Group', color: '#7c3aed', icon: '📁' },
  value_stream: { name: 'Value Stream', color: '#0d9488', icon: '➡️' },
  assessment: { name: 'Assessment', color: '#f59e0b', icon: '📊' },
  gap: { name: 'Gap', color: '#dc2626', icon: '⚠️' },
  initiative: { name: 'Initiative', color: '#10b981', icon: '🚀' },
};

// ============ COLORS ============

const COLORS = {
  capability: '#6366f1',      // --module-indigo
