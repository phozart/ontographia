...
export default function GuidedEAWorkspace() {
  ...
  return (
    <div className={styles.workspace} style={{ flexDirection: 'row' }}>
      {/* Left Navigation */}
      <EANavigator
      ...
      <main className={styles.main} style={{ flex: 1 }}>
        ...
        {activeSection === 'overview' && (
          <div className={styles.overview}>
            <div className={styles.overviewHeader}>
              <h1>Enterprise Architecture Studio</h1>
              <p>Document and understand how your business, applications, and technology work together</p>
            </div>
        ...
        {activeSection === 'viewpoint' && activeViewpointId && (
          <div className={styles.elementsGrid} style={{ padding: 20, overflow: 'auto' }}>
            {(() => {
              const viewpoint = VIEWPOINTS.find(v => v.id === activeViewpointId);
              ...
              return (
                <>
                  <div className={styles.header} style={{ borderBottom: 'none', background: 'transparent', padding: '0 0 16px 0' }}>
                    <h1 style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                      <viewpoint.icon style={{ color: viewpoint.color, fontSize: 28 }} />
                      {viewpoint.label}
                    </h1>
                    <span className={styles.elementCount}>{filteredElements.length} elements</span>
                    <button
                      className="btn btn-primary"
                  ...
                  <p style={{ color: 'var(--text-muted)', marginBottom: 20 }}>{viewpoint.description}</p>
            ...
            {(() => {
              ...
              return (
                <>
                  <div className={styles.header} style={{ borderBottom: 'none', background: 'transparent', padding: '0 0 16px 0' }}>
                    <h1 style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                      <span style={{ fontSize: 28 }}>{LAYER_ICONS[activeLayerId]}</span>
                      {layer.name}
                    </h1>
                    <span className={styles.elementCount}>{filteredElements.length} elements</span>
                  </div>

                  <p style={{ color: 'var(--text-muted)', marginBottom: 20 }}>{layer.description}</p>
