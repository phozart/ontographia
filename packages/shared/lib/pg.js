    ...
    try {
      ...
      await client.query(`
        INSERT INTO menu_items (key, label, href, icon, default_section, roles, sort_order) VALUES
          ...
          ('business-service-studio', 'Service Management', '/app/spaces/bsm/catalog', 'MiscellaneousServicesIcon', 'workspace', '{admin,editor,viewer}', 1),
          ('performance-studio', 'Performance Studio', '/app/spaces/perf/dashboard', 'FlagIcon', 'workspace', '{admin,editor,viewer}', 2),
          ('governance-studio', 'Governance Studio', '/app/spaces/gov/decisions', 'GavelIcon', 'workspace', '{admin,editor,viewer}', 3),
          ('risk-studio', 'Risk & Resilience', '/app/spaces/risk/register', 'ShieldIcon', 'workspace', '{admin,editor,viewer}', 4),
          ('product-design', 'Product Design', '/app/spaces/pdw/discovery', 'LightbulbIcon', 'workspace', '{admin,editor,viewer}', 5),
      ...
      await client.query(`
        ...
        UPDATE menu_items SET href = '/app/spaces/bsm/catalog' WHERE key = 'business-service-studio';
        UPDATE menu_items SET href = '/app/spaces/perf/dashboard' WHERE key = 'performance-studio';
        UPDATE menu_items SET href = '/app/spaces/gov/decisions' WHERE key = 'governance-studio';
        UPDATE menu_items SET href = '/app/spaces/risk/register' WHERE key = 'risk-studio';
        UPDATE menu_items SET href = '/app/spaces/pdw/discovery' WHERE key = 'product-design';
        UPDATE menu_items SET href = '/app/spaces/ba/repository' WHERE key = 'requirements-studio';
      ...
      // Remove deprecated reasoning menu items
      await client.query(`
      ...
      await client.query(`
        INSERT INTO page_registry (path, name, category, section, description, default_roles, sort_order) VALUES
          ...
          ('/app/reasoning/learning', 'Learning Studio', 'Reasoning', 'reasoning', 'Academic learning and meta-cognition', '{admin,editor,viewer}', 42),
